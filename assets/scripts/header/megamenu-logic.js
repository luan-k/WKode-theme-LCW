window.addEventListener("load", () => {
  ...
  let mobile_menu_ul = document.querySelectorAll(".wkode-header--mobile .wkode-header__nav--bottom .wkode-header__menu-container .nav .menu-item-has-children");
  ...
  function openItem( item ) {
    ...
    console.log(verifyIfOpened( menu ));
    verifyIfOpened( menu ) ? menuOpenedAddClass(menu) : menuOpenedRemoveClass(menu);
  }
