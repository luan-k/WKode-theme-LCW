          ...
          <div class="wkode-footer__wrapper grid grid-cols-1 md:grid-cols-12 gap-14">
            ...
            <div class="wkode-footer__menu-class wkode-footer__menu-class-3">
              ...
              <nav class="wkode-header__icons-wrapper sub-menu mb-6">
                ...
                <a target="_blank" class="wkode-header__social-media-icon" href="#" style="background-image: url(<?php echo get_theme_file_uri('/assets/img/svg/facebook-logo-footer.svg'); ?>);">
                </a>
                ...
                <a target="_blank" class="wkode-header__social-media-icon" href="#" style="background-image: url(<?php echo get_theme_file_uri('/assets/img/svg/instagram-logo-footer.svg'); ?>);">
                </a>
              </nav>
