...
function create_taxonomy() {
    ...
    $labels = array(
        'name'                       => _x( 'Modelos', 'Taxonomy General Name', 'modelos' ),
        'singular_name'              => _x( 'Modelo', 'Taxonomy Singular Name', 'modelos' ),
        'menu_name'                  => __( 'Modelos', 'modelos' ),
        'all_items'                  => __( 'Todas os Modelos', 'modelos' ),
        'parent_item'                => __( 'Modelo Parente', 'modelos' ),
        'parent_item_colon'          => __( 'Modelo Parente:', 'modelos' ),
        'new_item_name'              => __( 'Novo Item', 'modelos' ),
        'add_new_item'               => __( 'Adicionar novo Item', 'modelos' ),
        'edit_item'                  => __( 'Editar Item', 'modelos' ),
        'update_item'                => __( 'Update Item', 'modelos' ),
        'view_item'                  => __( 'Ver Item', 'modelos' ),
        'separate_items_with_commas' => __( 'Separar Items com virgulas', 'modelos' ),
        'add_or_remove_items'        => __( 'Adiconar ou Remover Items', 'modelos' ),
        'choose_from_most_used'      => __( 'Escolher os Mais Usados', 'modelos' ),
        'popular_items'              => __( 'Items Populares', 'modelos' ),
        'search_items'               => __( 'Procurar Items', 'modelos' ),
        'not_found'                  => __( 'Não Encontrado', 'modelos' ),
        'no_terms'                   => __( 'Nenhum Item', 'modelos' ),
        'items_list'                 => __( 'Lista de Items', 'modelos' ),
        'items_list_navigation'      => __( 'Navegação de items de lista ', 'modelos' ),
    );
    $args = array(
        'labels'                     => $labels,
        'hierarchical'               => true,
